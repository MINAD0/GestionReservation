    ...
    <div class="panel-group">
        <div class="panel panel-default">
            <div class="panel-body bg-primary text-white" style="font-size: 16px; height: 100%; max-width: 100%; text-align: center; line-height: 2;">
                <div class="col mb-4">
                    <span style="font-size: 20px; font-weight: bold; font-family: 'Noto Serif', serif; ">Bonjour Mr  {{$reservation['title']}} </span><br>
                    <span style="font-size: 18px; font-weight: bold; font-family: 'Noto Serif', serif; ">{{$reservation['body']}}</span> <br>
                    La Salle : {{$reservation['Salle']}} <br>
                    La Filière : {{$reservation['Filiere']}} <br>
                    Le Groupe : {{$reservation['Groupe']}} <br>
                    Object : {{$reservation['Objet']}} <br>
