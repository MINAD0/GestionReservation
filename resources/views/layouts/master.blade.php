...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-primary rounded-0">
        <div class="container-fluid">
            <a href="{{route('index')}}">
                <img src="{{asset('/images/logo.png')}}" alt="" width="75" height="75" style="margin-right: 5px;">
            </a>
          ...
          @auth
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" style="font-size: 16px; margin-right: 20px;font-family: 'Noto Serif', serif;" aria-current="page" href="{{route('index')}}">Reservations</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="font-size: 16px; margin-right: 20px;font-family: 'Noto Serif', serif;" aria-current="page" href="{{route('cons')}}">Consultants</a>
                        </li>
                    </ul>
                ...
                @guest
                    ...
                    <li class="nav-item dropdown" style="font-size: 16px;">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" style="font-size: 16px;width: fit-content;" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" style="padding: 6px;" href="{{ route('logout') }}"
